...
class ReproductorMP3 : IReproducible
{
    ...
    public void Pausar()
    {
        Console.WriteLine("Pausando reproducción de MP3...");
    }

    public void Detener()
    {
        Console.WriteLine("Deteniendo reproducción de MP3...");
    }
}
...
class ReproductorVideo : IReproducible
{
    ...
    public void Pausar()
    {
        Console.WriteLine("Pausando reproducción de video...");
    }

    public void Detener()
    {
        Console.WriteLine("Deteniendo reproducción de video...");
    }
}
